...
public class FastForgingTest extends AbstractForgingTest {
    ...
    public void fastForgingTest() {
        ...
        properties.setProperty("kpl.disableGenerateBlocksThread", "false");
        properties.setProperty("kpl.enableFakeForging", "false");
        properties.setProperty("kpl.timeMultiplier", "1000");
