...
public class TokenTest extends BlockchainTest {
    ...
    public void testParseValidToken() throws Exception {
        ...
        Token actual = Token.parseToken(token, "http://kpl.org");
    ...
    public void testGenerateToken() throws Exception {
        ...
        String tokenString = Token.generateToken("secret", "http://kpl.org");
        int end = Kpl.getEpochTime();
        Token token = Token.parseToken(tokenString, "http://kpl.org");
    ...
    public void emptySecret() throws Exception {
        String tokenString = Token.generateToken("", "http://kpl.org");
        Token token = Token.parseToken(tokenString, "http://kpl.org");
        assertTrue(token.isValid());
    }
