...
public class TestApproveTransaction extends BlockchainTest {
    ...
    public void validVoteCasting() {
        ...
        APICall apiCall = new TwoPhasedMoneyTransferBuilder()
                .finishHeight(Kpl.getBlockchain().getHeight() + duration)
                .build();
        ...
        Assert.assertEquals(-50 * Constants.ONE_kpl - 2 * Constants.ONE_kpl, ALICE.getBalanceDiff());
        Assert.assertEquals(50 * Constants.ONE_kpl, BOB.getBalanceDiff());
    ...
    public void invalidVoteCasting() {
        ...
        Assert.assertEquals("ALICE balance: ", -2 * Constants.ONE_kpl, ALICE.getBalanceDiff());
    ...
    public void sendMoneyPhasedNoVoting() {
        ...
        Assert.assertEquals(-100 * Constants.ONE_kpl - fee, ALICE.getUnconfirmedBalanceDiff());
        // Recipient
        ...
        // Sender
        Assert.assertEquals(-100 * Constants.ONE_kpl - fee, ALICE.getBalanceDiff());
        Assert.assertEquals(-100 * Constants.ONE_kpl - fee, ALICE.getUnconfirmedBalanceDiff());
        // Recipient
