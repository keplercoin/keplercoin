...
import kpl.AccountCurrencyBalance;
...
public class TestCurrencyExchange extends BlockchainTest {
    ...
    public void buyCurrency() {
        ...
        Assert.assertEquals(new AccountCurrencyBalance(-1000*95 - Constants.ONE_kpl, -Constants.ONE_kpl, -500, 0),
        ...
        apiCall = new APICall.Builder("currencyBuy").
                secretPhrase(BOB.getSecretPhrase()).feeNQT(Constants.ONE_kpl).
        ...
        Assert.assertEquals(new AccountCurrencyBalance(-200*105 - Constants.ONE_kpl, -200*105 - Constants.ONE_kpl, 200, 200),
    ...
    public void sellCurrency() {
        ...
        // We now transfer 2000 units to the 2nd account so that this account can sell them for kpl
        apiCall = new APICall.Builder("transferCurrency").
                secretPhrase(ALICE.getSecretPhrase()).feeNQT(Constants.ONE_kpl).
                param("currency", currencyId).
        ...
        Assert.assertEquals(new AccountCurrencyBalance(-Constants.ONE_kpl, -Constants.ONE_kpl, -2000, -2000),
        ...
        Assert.assertEquals(new AccountCurrencyBalance(19000-Constants.ONE_kpl, 19000-Constants.ONE_kpl, -200, -200),
    ...
    private JSONObject publishExchangeOffer(String currencyId) {
        APICall apiCall = new APICall.Builder("publishExchangeOffer").
                ...
                param("deadline", "1440").
                param("currency", currencyId).
                param("buyRateNQT", "" + 95). // buy currency for kpl
                param("sellRateNQT", "" + 105). // sell currency for kpl
