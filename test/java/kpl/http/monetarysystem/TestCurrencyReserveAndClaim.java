...
public class TestCurrencyReserveAndClaim extends BlockchainTest {
    ...
    public void cancelCrowdFunding() {
        ...
        Assert.assertEquals(balanceNQT1 - Constants.ONE_kpl, ALICE.getBalance());
        Assert.assertEquals(balanceNQT2 - 2*Constants.ONE_kpl, BOB.getBalance());
    }
    ...
    public void crowdFundingDistribution() {
        ...
        Assert.assertEquals(balanceNQT1 - Constants.ONE_kpl - 200000 + (100000*10), ALICE.getBalance());
        Assert.assertEquals(balanceNQT2 - 2*Constants.ONE_kpl - 800000, BOB.getBalance());
    }
    ...
    public void crowdFundingDistributionRounding() {
        ...
        Assert.assertEquals(balanceNQT2 - Constants.ONE_kpl - 24 * 2, BOB.getBalance());
        Assert.assertEquals(balanceNQT3 - 2 * Constants.ONE_kpl - 24 * 8, CHUCK.getBalance());
