            ...
            firstNonMaskPos = null, $.each(mask.split(""), function(i, c) {
                ...
                function androidInputEvent() {
                    ...
                    if (oldVal && oldVal.length && oldVal.length > curVal.length) {
                        ...
                        var addressStart = curValUpper.indexOf('KPL-', 4);
                        if (addressStart > 0) {
                            var insertedAddress = curValUpper.substr(addressStart, 24);
                            if (/KPL\-[A-Z0-9]{4}\-[A-Z0-9]{4}\-[A-Z0-9]{4}\-[A-Z0-9]{5}/.test(insertedAddress)) {
                ...
                function keydownEvent(e) {
                    ...
                    if (e.keyCode == 8) {
                        ...
                        if (settings.unmask !== false) {
                            //backspace, remove
                            if ((pos.begin == 0 && pos.end == 24) || (currentInput == "KPL-____-____-____-_____" && pos.begin == 4)) {
                                input.val("");
                                $(this).trigger("unmask");
                                return;
                            }
                ...
                input.bind("keyup.remask", function(e) {
                    if (input.val().toLowerCase() == "kpl") {
                        input.val("").mask("KPL-****-****-****-*****")./*unbind(".remask").*/trigger("focus");
                    }
