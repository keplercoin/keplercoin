...
var krs = (function(krs, $, undefined) {
     ...
     *      krs.pages.my_page_name = function () {
     *          var view = krs.simpleview.get('my_page_name_page', {
    ...
    krs.simpleview = {
        ...
        get: function (element_id, scope) {
            ...
            krs.simpleview.callbacks[element_id] = [];
    ...
    Handlebars.registerHelper('callback', function(view, fn) {
        ...
        var callbacks = krs.simpleview.callbacks[view_id];
        var index = callbacks.length, self = this;
        callbacks.push(function (element) {
            fn.call(view, self, element);
        });
        return 'krs.simpleview.callbacks.'+view_id+'['+index+'].call(null, $(this))';
    });
