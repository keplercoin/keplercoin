...
var krs = (function(krs, $) {
    ...
    krs.forms.setPhasingOnlyControlComplete = function(response, data) {
        //krs.getAccountInfo();
    };

	krs.pages.account_control = function(callback) {
		
	}
	
	krs.setup.account_control = function() {
	...
	$("#set_mandatory_approval_modal").on("show.bs.modal", function(e) {
		...
		var context = {
			...
			inputName: "controlQuorumKPL",
			addonText: "kpl",
			addonI18n: "KPL-_unit"
		}
		var $elems = krs.initModalUIElement($modal, '.phasing_only_amount_KPL', 'simple_input_with_addon_modal_ui_element', context);
		...
		var $elems = krs.initModalUIElement($modal, '.phasing_only_asset_quantity', 'simple_input_with_addon_modal_ui_element', context);
		$elems.find('input').prop("disabled", true);
		...
		var $elems = krs.initModalUIElement($modal, '.phasing_only_currency_units', 'simple_input_with_addon_modal_ui_element', context);
		$elems.find('input').prop("disabled", true);
		...
		var $elems = krs.initModalUIElement($modal, '.add_phasing_only_whitelist_group', 'multi_accounts_modal_ui_element', context);
		$elems.find('input').prop("disabled", true);
		...
		var $elems = krs.initModalUIElement($modal, '.phasing_only_min_balance_model_group', 'min_balance_model_modal_ui_element', context);
		...
		context['inputName'] = 'controlMinBalanceKPL';
		context['addonText'] = 'KPL';
		context['addonI18n'] = 'KPL_unit';
		var $elems = krs.initModalUIElement($modal, '.phasing_only_min_balance_KPL', 'simple_input_with_addon_modal_ui_element', context);
		$elems.find('input').prop("disabled", true);
		$elems.hide();
		...
		var $elems = krs.initModalUIElement($modal, '.phasing_only_min_balance_asset_quantity', 'simple_input_with_addon_modal_ui_element', context);
		$elems.find('input').prop("disabled", true);
		$elems.hide();
		...
		var $elems = krs.initModalUIElement($modal, '.phasing_only_min_balance_currency_units', 'simple_input_with_addon_modal_ui_element', context);
		$elems.find('input').prop("disabled", true);
		$elems.hide();
		...
		$elems = krs.initModalUIElement($modal, '.phasing_only_holding_asset', 'add_asset_modal_ui_element', context);
		$elems.find('input').prop("disabled", true);
		$elems = krs.initModalUIElement($modal, '.phasing_only_holding_asset_optional', 'add_asset_modal_ui_element', context);
		$elems.find('input').prop("disabled", true);
		$elems.hide();
		...
		$elems = krs.initModalUIElement($modal, '.phasing_only_holding_currency', 'add_currency_modal_ui_element', context);
		$elems.find('input').prop("disabled", true);
		$elems = krs.initModalUIElement($modal, '.phasing_only_holding_currency_optional', 'add_currency_modal_ui_element', context);
		$elems.find('input').prop("disabled", true);
		$elems.hide();
