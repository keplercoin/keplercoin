...
import static kpl.user.JSONResponses.LOCK_ACCOUNT;
...
public final class UnlockAccount extends UserServlet.UserRequestHandler {
    ...
    JSONStreamAware processRequest(HttpServletRequest req, User user) throws IOException {
        ...
        if (account == null) {
            ...
            try (DbIterator<? extends Transaction> transactions = Kpl.getTransactionProcessor().getAllUnconfirmedTransactions()) {
            ...
            int blockchainHeight = Kpl.getBlockchain().getLastBlock().getHeight();
            try (DbIterator<? extends Block> blockIterator = Kpl.getBlockchain().getBlocks(accountId, 0)) {
            ...
            try (DbIterator<? extends Transaction> transactionIterator = Kpl.getBlockchain().getTransactions(accountId, (byte) -1, (byte) -1, 0, false)) {
