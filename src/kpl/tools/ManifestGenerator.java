...
import kpl.Kpl;
import kpl.env.service.kplService_ServiceManagement;
...
public class ManifestGenerator {
    ...
    public static void main(String[] args) {
        ...
        manifestGenerator.generate("./resource/kpl.manifest.mf", Kpl.class.getCanonicalName(), "./lib");
        String serviceClassName = kplService_ServiceManagement.class.getCanonicalName();
        serviceClassName = serviceClassName.substring(0, serviceClassName.length() - "_ServiceManagement".length());
        manifestGenerator.generate("./resource/kplservice.manifest.mf", serviceClassName, "./lib");
    }
