...
/**
 * Handle logging for the kpl node server
 */
public final class Logger {
     ...
     * The kpl/conf/logging-default.properties and kpl/conf/logging.properties configuration
    ...
    static {
        ...
        System.setProperty("java.util.logging.manager", "kpl.util.kplLogManager");
        if (!(LogManager.getLogManager() instanceof kplLogManager)) {
            System.setProperty("java.util.logging.manager",
                    (oldManager != null ? oldManager : "java.util.logging.LogManager"));
        }
        if (! Boolean.getBoolean("kpl.doNotConfigureLogging")) {
            try {
                Properties loggingProperties = new Properties();
                Kpl.loadProperties(loggingProperties, "logging-default.properties", true);
                Kpl.loadProperties(loggingProperties, "logging.properties", false);
                Kpl.updateLogFileHandler(loggingProperties);
        ...
        log = org.slf4j.LoggerFactory.getLogger(kpl.Kpl.class);
        enableStackTraces = Kpl.getBooleanProperty("kpl.enableStackTraces");
        enableLogTraceback = Kpl.getBooleanProperty("kpl.enableLogTraceback");
    ...
    public static void shutdown() {
        if (LogManager.getLogManager() instanceof kplLogManager) {
            ((kplLogManager) LogManager.getLogManager()).kplShutdown();
        }
    }
