...
public final class Convert {
    ...
    public static String rsAccount(long accountId) {
        return "KPL-" + Crypto.rsEncode(accountId);
    }
    ...
    public static String readString(ByteBuffer buffer, int numBytes, int maxLength) throws kplException.NotValidException {
        if (numBytes > 3 * maxLength) {
            throw new kplException.NotValidException("Max parameter length exceeded");
        }
    ...
    public static long parsekpl(String kpl) {
        return parseStringFraction(kpl, 8, Constants.MAX_BALANCE_kpl);
    }
