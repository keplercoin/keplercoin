...
import kpl.kplException.kplIOException;
...
public class CountingInputReader extends FilterReader {
     ...
     * @throws  kplIOException      Maximum count exceeded
     */
    private void incCount(long c) throws kplIOException {
        count += c;
        if (count > limit)
            throw new kplIOException("Maximum size exceeded: " + count);
    }
}
