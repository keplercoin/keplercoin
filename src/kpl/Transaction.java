...
public interface Transaction {
    ...
    interface Builder {
        ...
        Transaction build() throws kplException.NotValidException;

        Transaction build(String secretPhrase) throws kplException.NotValidException;
    ...
    void validate() throws kplException.ValidationException;
