...
public class DesktopMode implements RuntimeMode {
    ...
    public void launchDesktopApplication() {
        ...
        try {
            desktopApplication = Class.forName("kpldesktop.DesktopApplication");
            desktopApplication.getMethod("launch").invoke(null);
        } catch (ReflectiveOperationException e) {
            Logger.logInfoMessage("kpldesktop.DesktopApplication failed to launch", e);
        }
    }
    ...
    public void shutdown() {
        ...
        try {
            ...
            Logger.logInfoMessage("kpldesktop.DesktopApplication failed to shutdown", e);
        }
    }
}
