...
public final class AddOns {
    ...
    static {
        ...
        Kpl.getStringListProperty("kpl.addOns").forEach(addOn -> {
            try {
        ...
        if (!addOns.isEmpty()) {
            System.setProperty("java.security.policy", Kpl.isDesktopApplicationEnabled() ? "kpldesktop.policy" : "kpl.policy");
