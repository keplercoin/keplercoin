...
public interface TransactionProcessor extends Observable<List<? extends Transaction>,TransactionProcessor.Event> {
    ...
    void broadcast(Transaction transaction) throws kplException.ValidationException;

    void processPeerTransactions(JSONObject request) throws kplException.ValidationException;
    ...
    List<Transaction> restorePrunableData(JSONArray transactions) throws kplException.NotValidException;
}
