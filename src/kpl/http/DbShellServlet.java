...
public final class DbShellServlet extends HttpServlet {
    ...
    private static final String header =
            "<!DOCTYPE html>\n" +
                    ...
                    "<head>\n" +
                    "    <meta charset=\"UTF-8\"/>\n" +
                    "    <title>kpl H2 Database Shell</title>\n" +
    ...
    private static final String errorNoPasswordIsConfigured =
            "This page is password-protected, but no password is configured in kpl.properties. " +
                    "Please set kpl.adminPassword or disable the password protection with kpl.disableAdminPassword";
    ...
    private static final String passwordFormWrongPassword = String.format(passwordFormTemplate, 
            "<p style=\"color:red\">The provided password does not match the value of kpl.adminPassword. Please try again!</p>");
