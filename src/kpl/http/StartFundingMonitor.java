...
import static kpl.http.JSONResponses.MONITOR_ALREADY_STARTED;
import static kpl.http.JSONResponses.UNKNOWN_ACCOUNT;
import static kpl.http.JSONResponses.incorrect;

/**
 * Start a funding monitor
 * <p>
 * A funding monitor will transfer kpl, ASSET or CURRENCY from the funding account
 ...
 * <p>
 * kpl amounts are specified with 8 decimal places.  Asset and Currency decimal places
...
public final class StartFundingMonitor extends APIServlet.APIRequestHandler {
     ...
     * @throws  kplException        Unable to process request
     */
    @Override
