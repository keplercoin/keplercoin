...
import kpl.http.EventListener.PendingEvent;
 ...
 * kpl.apiEventTimeout will be used if no timeout value is specified or
 * if the requested timeout is greater than kpl.apiEventTimeout.</li>
 * </ul>
 *
