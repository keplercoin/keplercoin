...
import static kpl.http.JSONResponses.FEATURE_NOT_AVAILABLE;
import static kpl.http.JSONResponses.INCORRECT_DEADLINE;
import static kpl.http.JSONResponses.INCORRECT_LINKED_FULL_HASH;
import static kpl.http.JSONResponses.INCORRECT_WHITELIST;
import static kpl.http.JSONResponses.MISSING_DEADLINE;
import static kpl.http.JSONResponses.MISSING_SECRET_PHRASE;
import static kpl.http.JSONResponses.NOT_ENOUGH_FUNDS;
...
abstract class CreateTransaction extends APIServlet.APIRequestHandler {
    ...
    private Appendix.Phasing parsePhasing(HttpServletRequest req) throws ParameterException {
        int finishHeight = ParameterParser.getInt(req, "phasingFinishHeight",
                Kpl.getBlockchain().getHeight() + 1,
                Kpl.getBlockchain().getHeight() + Constants.MAX_PHASING_DURATION + 1,
                true);
    ...
    final JSONStreamAware createTransaction(HttpServletRequest req, Account senderAccount, long recipientId,
                                            long amountNQT, Attachment attachment) throws kplException {
        ...
        try {
            Transaction.Builder builder = Kpl.newTransactionBuilder(publicKey, amountNQT, feeNQT,
            ...
            } catch (kplException.NotYetEncryptedException ignore) {}
        ...
        } catch (kplException.NotYetEnabledException e) {
