...
/**
 * Issue a currency on the kpl blockchain
 * <p>
 * A currency is the basic block of the kpl Monetary System it can be exchanged with kpl, transferred between accounts,
 ...
 * For {@link kpl.CurrencyType#RESERVABLE} currency
 * <li>minReservePerUnitNQT - the minimum kpl value per unit to allow the currency to become active
 * For {@link kpl.CurrencyType#RESERVABLE} currency
 ...
 * For {@link kpl.CurrencyType#MINTABLE} currency
 * <li>maxDifficulty - for mint-able currency, the exponent of the final difficulty.
 * For {@link kpl.CurrencyType#MINTABLE} currency
 * <li>algorithm - the hashing {@link kpl.crypto.HashFunction algorithm} used for minting.
 * For {@link kpl.CurrencyType#MINTABLE} currency
 * </ul>
 * <p>
 * Constraints
 * <ul>
 * <li>A given currency can not be neither {@link kpl.CurrencyType#EXCHANGEABLE} nor {@link kpl.CurrencyType#CLAIMABLE}.<br>
 * <li>A {@link kpl.CurrencyType#RESERVABLE} currency becomes active once the blockchain height reaches the currency issuance height.<br>
 ...
 * When a {@link kpl.CurrencyType#RESERVABLE} becomes active, in case it is {@link kpl.CurrencyType#CLAIMABLE} the kpl used for
 * reserving the currency are locked until they are claimed back.
 * When a {@link kpl.CurrencyType#RESERVABLE} becomes active, in case it is non {@link kpl.CurrencyType#CLAIMABLE} the kpl used for
 * reserving the currency are sent to the issuer account as crowd funding.
 * <li>When issuing a {@link kpl.CurrencyType#MINTABLE} currency, the number of units per {@link kpl.http.CurrencyMint} cannot exceed 0.01% of the
 ...
 * difficulty increases linearly with the number units minted per {@link kpl.http.CurrencyMint}<br>
 * </ul>
 *
 * @see kpl.CurrencyType
 * @see kpl.crypto.HashFunction
 */
