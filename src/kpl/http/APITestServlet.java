...
public class APITestServlet extends HttpServlet {
    ...
    private static final String header1 =
            ...
            "           <a class='navbar-brand' href='/test'>kpl http API</a>\n" +
            "       </div>\n" +
            "       <div class='navbar-collapse collapse'>\n" +
            "           <ul class='nav navbar-nav navbar-right'>\n" +
            "               <li><input type='text' class='form-control' id='search' " + 
            "                    placeholder='Search' style='margin-top:8px;'></li>\n" +
            "               <li><a href='https://kplwiki.org/wiki/The_kpl_API' target='_blank' style='margin-left:20px;'>Wiki Docs</a></li>\n" +
            "           </ul>\n" +
            "       </div>\n" +
            "   </div>\n" +
            "</div>\n" +
    ...
    private static String form(HttpServletRequest req, String requestType, boolean singleView, APIServlet.APIRequestHandler requestHandler) {
        ...
        buf.append("<a style='font-weight:normal;font-size:14px;color:#777;' href='https://kplwiki.org/wiki/The_kpl_API#");
        ...
        buf.append("<form action='/kpl' method='POST' ");
