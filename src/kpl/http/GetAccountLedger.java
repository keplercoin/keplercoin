 ...
 * account ledger tracks all account changes as determined by the kpl.ledgerAccounts,
 * kpl.ledgerLogUnconfirmed and kpl.ledgerTrimKeep properties.
 * </p>
 * <table>
 ...
 *           The administrator password is required if more than kpl.maxAPIRecords entries are to be searched.
 *       </td>
 *     </tr>
 *     <tr>
 *       <td>event</td>
 ...
 *           The maximum number of entries returned is limited by the kpl.maxAPIRecords property
 ...
 *     <tr>
 *       <td>kpl_BALANCE</td>
 *       <td>Change in the kpl balance for the account.  There is no 'holding'.</td>
 *     </tr>
 *     <tr>
 ...
 *     </tr>
 *     <tr>
 *       <td>UNCONFIRMED_kpl_BALANCE</td>
 *       <td>Change in the unconfirmed kpl balance for the account.  There is no 'holding'.</td>
 *     </tr>
 *   </tbody>
 * </table>
 */
public class GetAccountLedger extends APIServlet.APIRequestHandler {
     ...
     * @return                      API response
     * @throws  kplException        Invalid request
     */
    @Override
