...
public abstract class kplException extends Exception {

    protected kplException() {
        super();
    }

    protected kplException(String message) {
        super(message);
    }

    protected kplException(String message, Throwable cause) {
        super(message, cause);
    }

    protected kplException(Throwable cause) {
        super(cause);
    }

    public static abstract class ValidationException extends kplException {
    ...
    public static final class kplIOException extends IOException {

        public kplIOException(String message) {
            super(message);
        }

        public kplIOException(String message, Throwable cause) {
            super(message, cause);
        }
