...
javac -encoding utf8 -sourcepath "${SP}" -classpath "${CP}" -d classes/ src/java/kpl/*.java src/java/kpl/*/*.java src/java/kpl/*/*/*.java src/java/kpldesktop/*.java || exit 1

echo "kpl class files compiled successfully"
